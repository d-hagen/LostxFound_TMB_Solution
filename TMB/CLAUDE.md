...
- `index.html` — Single-page app with three tabs (Add Item / Find / Database). TMB-branded. All frontend logic is inline JS.
...
See `README.md` for the full 5-phase plan:
...
- Phase 3: GNN-Based Item Retrieval (replace full-DB prompt stuffing with graph neural network search)
- Phase 4: Passenger Web App (public-facing, privacy-preserving chatbot + claim form + info page)
- Phase 5: QR code labels with thermal printer integration
